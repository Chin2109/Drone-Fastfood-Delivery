...
const menuItemReducer = (state = initialState, action) => {
  switch (action.type) {
    case actionTypes.GET_MENU_ITEMS_REQUEST:
    case actionTypes.GET_MENU_ITEM_DETAIL_REQUEST:
    ...
    case actionTypes.GET_MENU_ITEM_DETAIL_SUCCESS:
      return {
        ...state,
        loading: false,
    ...
    case actionTypes.GET_MENU_ITEMS_FAILURE:
    case actionTypes.GET_MENU_ITEM_DETAIL_FAILURE:
